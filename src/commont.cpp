...
const string GENERATED_MAPS_SUBDIR_NAME = "generated";
...
void MasterSettings::load(LogSet& log) throw () {
    ...
    ifstream in((whereuserdir + "config" + directory_separator + "master.txt").c_str());
    ...
    FILE *fp = fopen((whereuserdir + "config" + directory_separator + "master.txt").c_str(), "rb");
    if (fp) {
